...
public class ReactionBlockerGamma implements ReactionBlocker {
	...
	public ReactionBlockerGamma(int xPos, int yPos, int width, int length, int structure,double xSpeed, double ySpeed) {
