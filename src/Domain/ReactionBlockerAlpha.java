...
public class ReactionBlockerAlpha implements ReactionBlocker {
	...
	public ReactionBlockerAlpha(int xPos, int yPos, int width, int length, int structure,double xSpeed, double ySpeed) {
