...
public class AtomSigma implements Atoms {
	...
	public AtomSigma(int xPos, int yPos, int width, int length, int neutron, int proton, double efficiency, double xSpeed, double ySpeed, ArrayList<ShieldDecorator> shields) {
	...
	public void addShields(ShieldDecorator s) {
		shields.add(s);
	}
