...
public class AtomGamma implements Atoms {
	...
	public AtomGamma(int xPos, int yPos, int width, int length, int neutron, int proton, double efficiency, double xSpeed, double ySpeed, ArrayList<ShieldDecorator> shields) {
