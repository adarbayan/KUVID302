...
public class AtomBeta implements Atoms {
	...
	public AtomBeta(int xPos, int yPos, int width, int length, int neutron, int proton, double efficiency, double xSpeed, double ySpeed, ArrayList<ShieldDecorator> shields) {
