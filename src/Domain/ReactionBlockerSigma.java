...
public class ReactionBlockerSigma implements ReactionBlocker {
	...
	public ReactionBlockerSigma(int xPos, int yPos, int width, int length, int structure,double xSpeed, double ySpeed) {
